    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <div style={{ fontSize: 28, fontWeight: 800, color: '#1B1A1C' }}>CARNAVAL</div>
          <div style={{ fontSize: 13, fontWeight: 700, color: '#C2117A', letterSpacing: 4 }}>IMPRIM</div>
        ...
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              style={{ width: '100%', padding: '11px 14px', border: '1px solid #E4DDD6', borderRadius: 10, fontSize: 14, outline: 'none' }}
            />
          </div>
          ...
          <button
            ...
            disabled={loading}
            style={{
              width: '100%', padding: '13px', background: '#C2117A', color: '#fff',
